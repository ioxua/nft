...
def get_all_chars_from_ttf(font_file):
    """
    ...
    filtered = list(dict.fromkeys(filter(is_char_valid, chars)))
    # print('filtered', filtered)
    return filtered


def render_chars_from_font(crypto_font_file, crypto_size=16):
    ...
    all_chars = get_all_chars_from_ttf(crypto_font_file)
    # print(all_chars)

    for char in all_chars:
        # [(unicode_point, character, unicode_name?)]
        crypto_file_name = char[2].replace(' ', '_').lower()
        render_character(char[1], crypto_font, crypto_file_name)


def render_character(crypto_char, crypto_font, crypto_file_name):
    """
    ...
    crypto_img.save(f'/Users/yehoshuaoliveira/Workspace/Ioxua/nft/results/temp/{crypto_file_name}.png')

crypto_font_path = "/Users/yehoshuaoliveira/Workspace/Ioxua/nft/image_generation/fonts/Roboto/Roboto-Regular.ttf"
render_chars_from_font(crypto_font_path, crypto_size=220)